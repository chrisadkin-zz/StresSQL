...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_01_152C6B0], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_01_152C6B0.mdf') TO FILEGROUP [FG_01];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_02_54CF5B09], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_02_54CF5B09.mdf') TO FILEGROUP [FG_02];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [imoltp_mod_3808DEDD], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_imoltp_mod_3808DEDD.mdf') TO FILEGROUP [imoltp_mod];
