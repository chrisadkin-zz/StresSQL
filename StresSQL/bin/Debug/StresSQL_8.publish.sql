...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_01_315C712E], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_01_315C712E.mdf') TO FILEGROUP [FG_01];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_02_6CA26763], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_02_6CA26763.mdf') TO FILEGROUP [FG_02];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [imoltp_mod_1CDE5C8F], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_imoltp_mod_1CDE5C8F.mdf') TO FILEGROUP [imoltp_mod];
