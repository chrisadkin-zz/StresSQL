...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_01_1C0A9607], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_01_1C0A9607.mdf') TO FILEGROUP [FG_01];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_02_29CD88FC], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_02_29CD88FC.mdf') TO FILEGROUP [FG_02];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [imoltp_mod_AB2B849], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_imoltp_mod_AB2B849.mdf') TO FILEGROUP [imoltp_mod];
