...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_02_2ABC354D], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_02_2ABC354D.mdf') TO FILEGROUP [FG_02];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [imoltp_mod_1D6F2ECC], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_imoltp_mod_1D6F2ECC.mdf') TO FILEGROUP [imoltp_mod];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_01_5B4396DF], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_01_5B4396DF.mdf') TO FILEGROUP [FG_01];
...
GO
PRINT N'Creating [dbo].[MyQLmaxImOltpNoLog]...';
...
GO
PRINT N'Creating [dbo].[MyQLmaxImOltpTemporal]...';
...
GO
PRINT N'Creating [dbo].[NonBlockingSequenceHashIndex]...';


GO
CREATE TABLE [dbo].[NonBlockingSequenceHashIndex] (
    [ID] BIGINT IDENTITY (1, 1) NOT NULL,
    PRIMARY KEY NONCLUSTERED HASH ([ID]) WITH (BUCKET_COUNT = 4000000)
)
WITH (DURABILITY = SCHEMA_ONLY, MEMORY_OPTIMIZED = ON);
...
GO
PRINT N'Creating [dbo].[SequenceCache1000]...';
...
GO
PRINT N'Creating [dbo].[SequenceCache2000]...';
...
GO
PRINT N'Creating [dbo].[SequenceCache3000]...';
...
GO
PRINT N'Creating [dbo].[SequenceCache500]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_PopMessageImOltpNoSequenceNoLog]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageImOltpNoSequenceNoLog]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_ScalableSequenceCache1000]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_ScalableSequenceCache2000]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_ScalableSequenceCache3000]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_ScalableSequenceCache500]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_ScalableSequenceImHashInsertDelete]...';
...
WITH ( TRANSACTION ISOLATION LEVEL = SNAPSHOT
	...
	SET    Id = Id + 1
	SELECT @SequenceNum = Id % @RolloverValue
...
END;
GO
PRINT N'Creating [dbo].[usp_TableVar]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_TableVarDisk]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_TableVarImOltp]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_TempTable]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_LmaxPopImOltpNoSequence]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_LmaxPopImOltpNoSequenceNoLog]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_LmaxPopImOltpNoSequenceTemporal]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_LmaxPushImOltpNoSequenceNoLog]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_LmaxPushImOltpNoSequenceTemporal]...';
