...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_01_7F0C2659], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_01_7F0C2659.mdf') TO FILEGROUP [FG_01];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_02_79B36569], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_02_79B36569.mdf') TO FILEGROUP [FG_02];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [imoltp_mod_4523F3B1], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_imoltp_mod_4523F3B1.mdf') TO FILEGROUP [imoltp_mod];
...
GO
PRINT N'Creating [dbo].[MyBigTableNewid]...';


GO
CREATE TABLE [dbo].[MyBigTableNewid] (
    [c1] UNIQUEIDENTIFIER NOT NULL,
    [c2] DATETIME         NULL,
    [c3] CHAR (111)       NULL,
    [c4] INT              NULL,
    [c5] INT              NULL,
    [c6] BIGINT           NULL,
    CONSTRAINT [PK_BigTableNewid] PRIMARY KEY CLUSTERED ([c1] ASC)
);


GO
PRINT N'Creating [dbo].[MyBigTablePart]...';


GO
CREATE TABLE [dbo].[MyBigTablePart] (
...
GO
PRINT N'Creating [dbo].[StressTestStats]...';


GO
CREATE TABLE [dbo].[StressTestStats] (
...
GO
PRINT N'Creating unnamed constraint on [dbo].[MyBigTableNewid]...';


GO
ALTER TABLE [dbo].[MyBigTableNewid]
    ADD DEFAULT (newid()) FOR [c1];


GO
PRINT N'Creating [dbo].[DF_BigTableNewid_c2]...';


GO
ALTER TABLE [dbo].[MyBigTableNewid]
    ADD CONSTRAINT [DF_BigTableNewid_c2] DEFAULT (getdate()) FOR [c2];


GO
PRINT N'Creating [dbo].[DF_BigTableNewid_c3]...';


GO
ALTER TABLE [dbo].[MyBigTableNewid]
    ADD CONSTRAINT [DF_BigTableNewid_c3] DEFAULT ('a') FOR [c3];


GO
PRINT N'Creating [dbo].[DF_BigTableNewid_c4]...';


GO
ALTER TABLE [dbo].[MyBigTableNewid]
    ADD CONSTRAINT [DF_BigTableNewid_c4] DEFAULT ((1)) FOR [c4];


GO
PRINT N'Creating [dbo].[DF_BigTableNewid_c5]...';


GO
ALTER TABLE [dbo].[MyBigTableNewid]
    ADD CONSTRAINT [DF_BigTableNewid_c5] DEFAULT ((2)) FOR [c5];


GO
PRINT N'Creating [dbo].[DF_BigTableNewid_c6]...';


GO
ALTER TABLE [dbo].[MyBigTableNewid]
    ADD CONSTRAINT [DF_BigTableNewid_c6] DEFAULT ((42)) FOR [c6];
...
END;
GO
PRINT N'Creating [dbo].[usp_insertInit]...';


GO

CREATE PROCEDURE [dbo].[usp_insertInit] 
AS
BEGIN
...
END;
GO
PRINT N'Creating [dbo].[usp_InsertNewid]...';


GO

CREATE PROCEDURE [dbo].[usp_InsertNewid]
     @BatchSize    int = 1
...
BEGIN
    ...
    BEGIN
        BEGIN TRANSACTION
            INSERT INTO dbo.MyBigTableNewid 
                DEFAULT VALUES;
...
END;
GO
PRINT N'Creating [dbo].[usp_LMaxInit]...';
...
CREATE PROCEDURE [dbo].[usp_LmaxPopDiskSequence] 
AS 
BEGIN 
...
END;
GO
PRINT N'Creating [dbo].[usp_PopMessageDiskNode0V3]...';


GO
CREATE PROCEDURE [dbo].[usp_PopMessageDiskNode0V3]  @MessagePopped int OUTPUT
                                                  ,@QueueSize     int = 4000000
AS
BEGIN 
...
END;
GO
PRINT N'Creating [dbo].[usp_PopMessageDiskNode0V4]...';


GO
CREATE PROCEDURE [dbo].[usp_PopMessageDiskNode0V4]  @MessagePopped int OUTPUT
                                                  ,@QueueSize     int = 4000000
AS
BEGIN 
    DECLARE  @Message  char(300)
...
END;
GO
PRINT N'Creating [dbo].[usp_PopMessageDiskNode1V3]...';


GO
CREATE PROCEDURE [dbo].[usp_PopMessageDiskNode1V3]  @MessagePopped int OUTPUT
                                                  ,@QueueSize     int = 4000000
AS
BEGIN 
    DECLARE  @Message char(300)
...
END;
GO
PRINT N'Creating [dbo].[usp_PopMessageDiskNode1V4]...';


GO
CREATE PROCEDURE [dbo].[usp_PopMessageDiskNode1V4]  @MessagePopped int OUTPUT
                                                  ,@QueueSize     int = 4000000
AS
BEGIN 
    DECLARE  @Message  char(300)
...
END;
GO
PRINT N'Creating [dbo].[usp_PopMessageNoSequence]...';
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageDiskInitNuma]...';


GO

CREATE PROCEDURE [dbo].[usp_PushMessageDiskInitNuma]  
AS
BEGIN 
    DECLARE  @QueueSize int = 4000000
	        ,@Slot      bigint
    ...
    DELETE FROM [dbo].[MyQLmaxNode0];
    DELETE FROM [dbo].[MyQLmaxNode1];
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageDiskInitNumaV3]...';


GO

CREATE PROCEDURE [dbo].[usp_PushMessageDiskInitNumaV3]  
AS
BEGIN 
    DECLARE  @QueueSize int = 4000000
	        ,@Slot      bigint
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageDiskNode0V3]...';


GO
CREATE PROCEDURE [dbo].[usp_PushMessageDiskNode0V3]  @MessagePushed int OUTPUT
                                                   ,@QueueSize     int = 4000000
AS
BEGIN 
    DECLARE @Slot bigint;
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageDiskNode0V4]...';


GO

CREATE PROCEDURE [dbo].[usp_PushMessageDiskNode0V4]  @MessagePushed int OUTPUT
                                                    ,@QueueSize     int = 4000000
AS
BEGIN 
    DECLARE @Slot bigint;
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageDiskNode1V3]...';


GO
CREATE PROCEDURE [dbo].[usp_PushMessageDiskNode1V3]  @MessagePushed int OUTPUT
                                                   ,@QueueSize     int = 4000000
AS
BEGIN 
    DECLARE @Slot bigint;
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageDiskNode1V4]...';


GO

CREATE PROCEDURE [dbo].[usp_PushMessageDiskNode1V4]  @MessagePushed int OUTPUT
                                                    ,@QueueSize     int = 4000000
AS
BEGIN 
    DECLARE @Slot bigint;
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageDiskV1]...';


GO
CREATE PROCEDURE [dbo].[usp_PushMessageDiskV1]  @MessagePushed int OUTPUT
                                              ,@QueueSize     int = 4000000
AS
BEGIN 
    DECLARE @Slot bigint;
	...
	WHILE @MessagePushed = 0
	BEGIN
	    EXEC [dbo].[usp_GetPushSlotId] @Slot;
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageDiskV2]...';


GO

CREATE PROCEDURE [dbo].[usp_PushMessageDiskV2]  @MessagePushed int OUTPUT
                                               ,@QueueSize     int = 4000000
AS
BEGIN 
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageImOltpV1]...';


GO
CREATE PROCEDURE [dbo].[usp_PushMessageImOltpV1]  @Slot          int
                                           ,@MessagePushed int                    
                                            OUTPUT
WITH NATIVE_COMPILATION, SCHEMABINDING
AS
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageImOltpV2]...';


GO
CREATE PROCEDURE [dbo].[usp_PushMessageImOltpV2]   @Slot          int
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageNoSequence]...';


GO


CREATE PROCEDURE [dbo].[usp_PushMessageNoSequence] @MessagePushed int OUTPUT
AS
BEGIN 
    DECLARE  @QueueSize int    = 4000000
	        ,@Message   char(300)
...
END;
GO
PRINT N'Creating [dbo].[usp_StressTestHarness]...';
...
CREATE PROCEDURE [dbo].[usp_StressTestHarness] 
     @test                  varchar(256)
	,@StartThread           int           = 1
	,@EndThread             int           = 20
    ,@Procedure1            VARCHAR(256)  = 'LmaxPushV3Wrapper'
    ,@Procedure2            VARCHAR(256)  = 'NO POP PROCEDURE'
	,@InitProcedure         VARCHAR(256)  = 'NO INIT PROCEDURE'
	...
	BEGIN		
		...
		SET @PshCmd = 'PowerShell.exe -noprofile -command ' + '"' +
                      'for($i=1; $i -le ' + CAST(@i AS char(2)) + '; $i++) { ' +
						   ...
						   ' -ServerInstance ' + @server + ' -Query \"EXECUTE ' + @Procedure1 + '\" }'
						   
		IF @Procedure2 <> 'NO POP PROCEDURE'
		BEGIN						   
			SET @PshCmd += '; ' +
	                       'Start-Job { Invoke-sqlcmd -Database ' + @DatabaseName + 
						   ' -ServerInstance ' + @server + ' -Query \"EXECUTE ' + @Procedure2  + '\" }'  
		END;
...
CREATE PROCEDURE [dbo].[usp_LmaxPopDiskNoSequence] 
AS 
BEGIN 
    DECLARE  @QueueSize     int = 200000
            ,@MessagePopped int
...
CREATE PROCEDURE [dbo].[usp_LmaxPopDiskNumaNoSequence] 
AS 
BEGIN 
    DECLARE  @QueueSize     int = 200000
            ,@MessagePopped int
...
CREATE PROCEDURE [dbo].[usp_LmaxPopDiskNumaSequence] 
AS 
BEGIN 
    DECLARE  @QueueSize     int = 200000
            ,@MessagePopped int
...
BEGIN 
	...
	WHILE @i <= @QueueSize 
	BEGIN
		EXEC dbo.usp_PushMessageNoSequence @MessagePopped OUTPUT; 
		SET @i += 1;
	END;
END;
GO
...
BEGIN 
	...
	BEGIN
		WHILE @i <= @QueueSize 
		BEGIN
			EXEC dbo.usp_PushMessageDiskNode0V4 @MessagePushed OUTPUT; 
			SET @i += 1;
		END;
	END
	ELSE
	BEGIN
		WHILE @i <= @QueueSize 
		BEGIN
			EXEC dbo.usp_PushMessageDiskNode1V4 @MessagePushed OUTPUT; 
			SET @i += 1;
		END;
	END
END;
...
BEGIN 
	...
	BEGIN
		WHILE @i <= @QueueSize 
		BEGIN
			EXEC dbo.usp_PushMessageDiskNode0V3 @MessagePushed OUTPUT; 
			SET @i += 1;
		END;
	END
	ELSE
	BEGIN
		WHILE @i <= @QueueSize 
		BEGIN
			EXEC dbo.usp_PushMessageDiskNode1V3 @MessagePushed OUTPUT; 
			SET @i += 1;
		END;
	END
END;
...
END;
GO
PRINT N'Creating [dbo].[usp_LmaxPushImOltpV1]...';


GO
CREATE PROCEDURE [dbo].[usp_LmaxPushImOltpV1] 
AS 
BEGIN 
    DECLARE  @QueueSize     int = 200000
            ,@MessagePushed int
    ...
    WHILE @i <= @QueueSize 
    BEGIN
        EXEC usp_GetPushSlotId @Slot OUTPUT, @QueueSize;
        EXEC dbo.usp_PushMessageImOltpV1  @Slot
                                         ,@MessagePushed OUTPUT; 
    END;
END;
GO
PRINT N'Creating [dbo].[usp_LmaxPushImOltpV2]...';


GO
CREATE PROCEDURE [dbo].[usp_LmaxPushImOltpV2] 
AS 
BEGIN 
    DECLARE  @QueueSize     int = 200000
            ,@MessagePushed int
    ...
    WHILE @i <= @QueueSize 
    BEGIN
        EXEC dbo.usp_PushMessageImOltpV2  @Slot
                                         ,@MessagePushed OUTPUT; 
    END;
END;
GO
...
--------------------------------------------------------------------------------------
*/
EXECUTE [dbo].[usp_PushMessageDiskInitNonNuma];
EXECUTE [dbo].[usp_PushMessageDiskInitNuma];
GO
