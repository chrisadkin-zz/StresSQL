...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_01_57D5813F], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_01_57D5813F.mdf') TO FILEGROUP [FG_01];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [FG_02_7064F27E], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_FG_02_7064F27E.mdf') TO FILEGROUP [FG_02];
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [imoltp_mod_2B15A50A], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_imoltp_mod_2B15A50A.mdf') TO FILEGROUP [imoltp_mod];
...
END;
GO
PRINT N'Creating [dbo].[usp_PushMessageDiskInitV1]...';
...
CREATE PROCEDURE [dbo].[usp_StressTestHarness] 
	...
	,@InitProcedure         VARCHAR(256)  = 'usp_LMaxInit'
...
BEGIN
    ...
    SET @WaitCmd =  'PowerShell.exe -noprofile -command ' + '"' +
