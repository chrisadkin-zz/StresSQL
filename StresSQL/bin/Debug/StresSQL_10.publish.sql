...
GO
PRINT N'Dropping [dbo].[MyQLmaxImOltpTemporalHist].[ix_MyQLmaxImOltpTemporalHist]...';


GO
DROP INDEX [ix_MyQLmaxImOltpTemporalHist]
    ON [dbo].[MyQLmaxImOltpTemporalHist];


GO
PRINT N'Dropping [dbo].[usp_ScalableSequenceImHashInsertDelete]...';


GO
DROP PROCEDURE [dbo].[usp_ScalableSequenceImHashInsertDelete];
...
GO
PRINT N'Starting rebuilding table [dbo].[NonBlockingSequenceHashIndex]...';


GO
CREATE TABLE [dbo].[tmp_ms_xx_NonBlockingSequenceHashIndex] (
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_NonBlockingSequenceHashIndex] ON;
        INSERT INTO [dbo].[tmp_ms_xx_NonBlockingSequenceHashIndex] ([ID])
        SELECT [ID]
        FROM   [dbo].[NonBlockingSequenceHashIndex];
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_NonBlockingSequenceHashIndex] OFF;
    END


GO
DROP TABLE [dbo].[NonBlockingSequenceHashIndex];
...
GO
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[tmp_ms_xx_NonBlockingSequenceHashIndex])
    BEGIN
        SET IDENTITY_INSERT [dbo].[NonBlockingSequenceHashIndex] ON;
        INSERT INTO [dbo].[NonBlockingSequenceHashIndex] ([ID])
        SELECT [ID]
        FROM   [dbo].[tmp_ms_xx_NonBlockingSequenceHashIndex];
        SET IDENTITY_INSERT [dbo].[NonBlockingSequenceHashIndex] OFF;
    END


GO
DROP TABLE [dbo].[tmp_ms_xx_NonBlockingSequenceHashIndex];
